...
/* UART */
#define UART_DEBUG_SCB__HW SCB6
#define UART_DEBUG_SCB__IDX 6
...
#define UART_DEBUG_SCBCLK__DIV_IDX 1
#define UART_DEBUG_SCBCLK__DIV_NUM 1
...
#define CY_PROJECT_NAME "UART_debug"
