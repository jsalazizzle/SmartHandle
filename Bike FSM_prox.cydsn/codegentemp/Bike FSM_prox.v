// ======================================================================
// Bike FSM_prox.v generated from TopDesign.cysch
// 01/14/2019 at 13:21
...
module CapSense_v2_0_14 ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("670e9353-cbf1-4ab3-b103-08ebe60be789/4db2e9d3-9f70-4f4e-a919-7eefada41863"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("670e9353-cbf1-4ab3-b103-08ebe60be789/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("670e9353-cbf1-4ab3-b103-08ebe60be789/0113321b-4a37-46f6-8407-2f8646c68756"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
...
module top ;
	...
	wire [0:0] tmpFB_0__Pin_Shake_net;
	wire [0:0] tmpIO_0__Pin_Shake_net;
	electrical [0:0] tmpSIOVREF__Pin_Shake_net;

	cy_mxs40_gpio_v1_0
		#(.id("d30caab5-2fe7-4bc3-86c2-db4d5f9c5a57"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("3"),
		  .ibuf_enabled("1"),
		...
		Pin_Shake
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Shake_net[0:0]}),
		  .io({tmpIO_0__Pin_Shake_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Shake_net));


    CapSense_v2_0_14 CapSense ();
