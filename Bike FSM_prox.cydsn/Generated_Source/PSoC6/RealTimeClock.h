...
#define RealTimeClock_INITIAL_DATE_HOUR         (13u)
#define RealTimeClock_INITIAL_DATE_HOUR_FORMAT  (CY_RTC_24_HOURS)
#define RealTimeClock_INITIAL_DATE_DOW          (2u)
#define RealTimeClock_INITIAL_DATE_DOM          (14u)
#define RealTimeClock_INITIAL_DATE_MONTH        (1u)
