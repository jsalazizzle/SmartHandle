...
/* Check for the proper BLESS ISR configuration in the DWR. */
        ...
        (!defined Bluetooth_bless_isr__INTC_CORTEXM4_ASSIGNED))
        #error Enable Bluetooth_bless_isr interrupt for the ARM CM4 core in the interrupt configuration tab of \
        ...
        (!defined Bluetooth_bless_isr__INTC_CORTEXM0P_ASSIGNED))
        #error Enable Bluetooth_bless_isr interrupt for the ARM CM0+ core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
...
/* Check for the proper UART ISR configuration in the DWR.  */
    ...
    #if((CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M4) && \
        (!defined Bluetooth_uart_isr__INTC_CORTEXM4_ASSIGNED))
        #error Enable Bluetooth_uart_isr interrupt for the ARM CM4 core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
    #endif /* CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M4 */
    
    #if((CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M0P) && \
        (!defined Bluetooth_uart_isr__INTC_CORTEXM0P_ASSIGNED))
        #error Enable Bluetooth_uart_isr interrupt for the ARM CM0+ core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
    #endif /* CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M0P */
...
/* Check for the proper HOST UART ISR configuration in the DWR.  */
        ...
        (!defined Bluetooth_host_uart_isr__INTC_CORTEXM4_ASSIGNED))
        #error Enable Bluetooth_host_uart_isr interrupt for the ARM CM4 core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
    #endif /* CY_BLE_CONFIG_HOST_CORE == CY_BLE_CORE_CORTEX_M4 */
    
    #if((CY_BLE_CONFIG_HOST_CORE == CY_BLE_CORE_CORTEX_M0P) && \
        (!defined Bluetooth_host_uart_isr__INTC_CORTEXM0P_ASSIGNED))
        #error Enable Bluetooth_host_uart_isr interrupt for the ARM CM0+ core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
...
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x0028u)
...
#define CY_BLE_DEVICE_ERROR_LOG_APPLICATION_LOG_CHAR_INDEX   (0x01u) /* Index of Application Log characteristic */
#define CY_BLE_DEVICE_ERROR_LOG_APPLICATION_LOG_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_DEVICE_ERROR_LOG_KINOS_LOG_CHAR_INDEX   (0x02u) /* Index of Kinos Log characteristic */
#define CY_BLE_DEVICE_ERROR_LOG_KINOS_LOG_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_DEVICE_USE_PROFILE_SERVICE_INDEX   (0x02u) /* Index of Device Use Profile service in the cy_ble_customs array */
#define CY_BLE_DEVICE_USE_PROFILE_CLEAR_LOG_CHAR_INDEX   (0x00u) /* Index of Clear Log characteristic */
#define CY_BLE_DEVICE_USE_PROFILE_USE_LOG_CHAR_INDEX   (0x01u) /* Index of Use Log characteristic */


#define CY_BLE_DEVICE_INTERFACE_SERVICE_HANDLE   (0x0010u) /* Handle of Device Interface service */
#define CY_BLE_DEVICE_INTERFACE_INBOUND_DECL_HANDLE   (0x0011u) /* Handle of Inbound characteristic declaration */
#define CY_BLE_DEVICE_INTERFACE_INBOUND_CHAR_HANDLE   (0x0012u) /* Handle of Inbound characteristic */
...
#define CY_BLE_DEVICE_ERROR_LOG_SERVICE_HANDLE   (0x001Bu) /* Handle of Device Error Log service */
#define CY_BLE_DEVICE_ERROR_LOG_CLEAR_LOG_DECL_HANDLE   (0x001Cu) /* Handle of Clear Log characteristic declaration */
#define CY_BLE_DEVICE_ERROR_LOG_CLEAR_LOG_CHAR_HANDLE   (0x001Du) /* Handle of Clear Log characteristic */
#define CY_BLE_DEVICE_ERROR_LOG_APPLICATION_LOG_DECL_HANDLE   (0x001Eu) /* Handle of Application Log characteristic declaration */
#define CY_BLE_DEVICE_ERROR_LOG_APPLICATION_LOG_CHAR_HANDLE   (0x001Fu) /* Handle of Application Log characteristic */
#define CY_BLE_DEVICE_ERROR_LOG_APPLICATION_LOG_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0020u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_DEVICE_ERROR_LOG_KINOS_LOG_DECL_HANDLE   (0x0021u) /* Handle of Kinos Log characteristic declaration */
#define CY_BLE_DEVICE_ERROR_LOG_KINOS_LOG_CHAR_HANDLE   (0x0022u) /* Handle of Kinos Log characteristic */
#define CY_BLE_DEVICE_ERROR_LOG_KINOS_LOG_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0023u) /* Handle of Client Characteristic Configuration descriptor */

#define CY_BLE_DEVICE_USE_PROFILE_SERVICE_HANDLE   (0x0024u) /* Handle of Device Use Profile service */
#define CY_BLE_DEVICE_USE_PROFILE_CLEAR_LOG_DECL_HANDLE   (0x0025u) /* Handle of Clear Log characteristic declaration */
#define CY_BLE_DEVICE_USE_PROFILE_CLEAR_LOG_CHAR_HANDLE   (0x0026u) /* Handle of Clear Log characteristic */
#define CY_BLE_DEVICE_USE_PROFILE_USE_LOG_DECL_HANDLE   (0x0027u) /* Handle of Use Log characteristic declaration */
#define CY_BLE_DEVICE_USE_PROFILE_USE_LOG_CHAR_HANDLE   (0x0028u) /* Handle of Use Log characteristic */
