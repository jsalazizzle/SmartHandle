...
static const cy_stc_ble_customs_t cy_ble_customs[0x03u] = {
    ...
    /* Device Interface service */
    {
        0x0010u, /* Handle of the Device Interface service */ 
        {
            ...
            {
                0x0012u, /* Handle of the Inbound characteristic */ 
            ...
            {
                0x0014u, /* Handle of the Outbound characteristic */ 
    ...
    {
        0x001Bu, /* Handle of the Device Error Log service */ 
        {

            /* Clear Log characteristic */
            {
                0x001Du, /* Handle of the Clear Log characteristic */ 
            ...
            {
                0x001Fu, /* Handle of the Application Log characteristic */ 
            ...
            {
                0x0022u, /* Handle of the Kinos Log characteristic */ 
    ...
    {
        0x0024u, /* Handle of the Device Use Profile service */ 
        {
            ...
            {
                0x0028u, /* Handle of the Use Log characteristic */ 
