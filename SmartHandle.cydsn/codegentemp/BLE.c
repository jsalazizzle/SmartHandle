...
cy_en_ble_api_result_t Cy_BLE_Start(cy_ble_callback_t callbackFunc)
{
    ...
    if(callbackFunc != NULL)
    {
        ...
        cy_ble_config.blessIsrConfig = &Bluetooth_bless_isr_cfg;
    #endif /* (CY_BLE_CONFIG_STACK_CONTR_CORE) */

    #if(CY_BLE_CONFIG_STACK_MODE_HOST_UART)
        cy_ble_config.uartHostIsrConfig = &Bluetooth_host_uart_isr_cfg;
        cy_ble_config.uartHostConfig = &Bluetooth_Host_Uart_config;
        cy_ble_config.uartHostHw = Bluetooth_Host_Uart_HW;
    #endif  /* (CY_BLE_CONFIG_STACK_MODE_HOST_UART) */
...
#else
{
    ...
    {
    #if(CY_BLE_CONFIG_STACK_CONTR_CORE)
        .blessIsrConfig = &Bluetooth_bless_isr_cfg,
    #endif /* (CY_BLE_CONFIG_STACK_CONTR_CORE) */
    
    #if(CY_BLE_CONFIG_STACK_MODE_CONTR_UART)
        .uartIsrConfig = &Bluetooth_uart_isr_cfg,
        .uartConfig = &Bluetooth_HAL_Uart_config,
        .uartHw = Bluetooth_HAL_Uart_HW
    #endif /* CY_BLE_CONFIG_STACK_MODE_CONTR_UART */
    };
