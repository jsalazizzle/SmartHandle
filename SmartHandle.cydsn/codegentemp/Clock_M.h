...
*
* \brief
* Provides the source code to the API for the Clock_M Component.
*
********************************************************************************
* \copyright
...
#if !defined(CY_Clock_M_NAME_Clock_M_H)
#define CY_Clock_M_NAME_Clock_M_H
...
#define Clock_M_DIV_NUM ((uint32_t)Clock_M__DIV_NUM)
/** The peripheral clock divider type */
#define Clock_M_DIV_TYPE ((cy_en_divider_types_t)Clock_M__DIV_TYPE)
/** @} group_macros */
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_M_Enable(void)
{
    (void)Cy_SysClk_PeriphEnableDivider(Clock_M_DIV_TYPE, Clock_M_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_M_Disable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_M_Disable(void)
{
    (void)Cy_SysClk_PeriphDisableDivider(Clock_M_DIV_TYPE, Clock_M_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_M_SetDivider
****************************************************************************//**
*
* Sets the value of a programmable clock divider assigned to this Component.
* This is only used for integer dividers. Use Clock_M_SetFracDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_M_SetDivider(uint32_t dividerValue)
{
    (void)Cy_SysClk_PeriphSetDivider(Clock_M_DIV_TYPE, Clock_M_DIV_NUM, dividerValue);
}

/*******************************************************************************
* Function Name: Clock_M_GetDivider
****************************************************************************//**
*
...
* Use Clock_M_GetFracDivider() with a fractional divider.
*
* \param None
*
* \return
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t Clock_M_GetDivider(void)
{
    return Cy_SysClk_PeriphGetDivider(Clock_M_DIV_TYPE, Clock_M_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_M_SetFracDivider
****************************************************************************//**
*
* Sets the values of a programmable clock divider assigned to this Component.
* This is only used for fractional dividers. Use Clock_M_SetDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_M_SetFracDivider(uint32_t dividerIntValue, uint32_t dividerFracValue)
{
    (void)Cy_SysClk_PeriphSetFracDivider(Clock_M_DIV_TYPE, Clock_M_DIV_NUM, dividerIntValue, dividerFracValue);
}

/*******************************************************************************
* Function Name: Clock_M_GetFracDivider
****************************************************************************//**
*
...
* Use Clock_M_GetDivider() with an integer divider.
*
* \param *dividerIntValue
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_M_GetFracDivider(uint32_t *dividerIntValue, uint32_t *dividerFracValue)
{
    Cy_SysClk_PeriphGetFracDivider(Clock_M_DIV_TYPE, Clock_M_DIV_NUM, dividerIntValue, dividerFracValue);
}

/** @} general */

#endif /* CY_CLOCK_Clock_M_H */
