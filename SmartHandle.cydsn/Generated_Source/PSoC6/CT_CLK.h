...
*
* \brief
* Provides the source code to the API for the CT_CLK Component.
*
********************************************************************************
* \copyright
...
#if !defined(CY_CT_CLK_NAME_CT_CLK_H)
#define CY_CT_CLK_NAME_CT_CLK_H
...
#define CT_CLK_DIV_NUM ((uint32_t)CT_CLK__DIV_NUM)
/** The peripheral clock divider type */
#define CT_CLK_DIV_TYPE ((cy_en_divider_types_t)CT_CLK__DIV_TYPE)
/** @} group_macros */
...
*
*******************************************************************************/
__STATIC_INLINE void CT_CLK_Enable(void)
{
    (void)Cy_SysClk_PeriphEnableDivider(CT_CLK_DIV_TYPE, CT_CLK_DIV_NUM);
}

/*******************************************************************************
* Function Name: CT_CLK_Disable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void CT_CLK_Disable(void)
{
    (void)Cy_SysClk_PeriphDisableDivider(CT_CLK_DIV_TYPE, CT_CLK_DIV_NUM);
}

/*******************************************************************************
* Function Name: CT_CLK_SetDivider
****************************************************************************//**
*
* Sets the value of a programmable clock divider assigned to this Component.
* This is only used for integer dividers. Use CT_CLK_SetFracDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void CT_CLK_SetDivider(uint32_t dividerValue)
{
    (void)Cy_SysClk_PeriphSetDivider(CT_CLK_DIV_TYPE, CT_CLK_DIV_NUM, dividerValue);
}

/*******************************************************************************
* Function Name: CT_CLK_GetDivider
****************************************************************************//**
*
...
* Use CT_CLK_GetFracDivider() with a fractional divider.
*
* \param None
*
* \return
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t CT_CLK_GetDivider(void)
{
    return Cy_SysClk_PeriphGetDivider(CT_CLK_DIV_TYPE, CT_CLK_DIV_NUM);
}

/*******************************************************************************
* Function Name: CT_CLK_SetFracDivider
****************************************************************************//**
*
* Sets the values of a programmable clock divider assigned to this Component.
* This is only used for fractional dividers. Use CT_CLK_SetDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void CT_CLK_SetFracDivider(uint32_t dividerIntValue, uint32_t dividerFracValue)
{
    (void)Cy_SysClk_PeriphSetFracDivider(CT_CLK_DIV_TYPE, CT_CLK_DIV_NUM, dividerIntValue, dividerFracValue);
}

/*******************************************************************************
* Function Name: CT_CLK_GetFracDivider
****************************************************************************//**
*
...
* Use CT_CLK_GetDivider() with an integer divider.
*
* \param *dividerIntValue
...
*
*******************************************************************************/
__STATIC_INLINE void CT_CLK_GetFracDivider(uint32_t *dividerIntValue, uint32_t *dividerFracValue)
{
    Cy_SysClk_PeriphGetFracDivider(CT_CLK_DIV_TYPE, CT_CLK_DIV_NUM, dividerIntValue, dividerFracValue);
}

/** @} general */

#endif /* CY_CLOCK_CT_CLK_H */
