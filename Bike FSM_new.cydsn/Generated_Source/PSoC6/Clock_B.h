...
*
* \brief
* Provides the source code to the API for the Clock_B Component.
*
********************************************************************************
* \copyright
...
#if !defined(CY_Clock_B_NAME_Clock_B_H)
#define CY_Clock_B_NAME_Clock_B_H
...
#define Clock_B_DIV_NUM ((uint32_t)Clock_B__DIV_NUM)
/** The peripheral clock divider type */
#define Clock_B_DIV_TYPE ((cy_en_divider_types_t)Clock_B__DIV_TYPE)
/** @} group_macros */
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_B_Enable(void)
{
    (void)Cy_SysClk_PeriphEnableDivider(Clock_B_DIV_TYPE, Clock_B_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_B_Disable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_B_Disable(void)
{
    (void)Cy_SysClk_PeriphDisableDivider(Clock_B_DIV_TYPE, Clock_B_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_B_SetDivider
****************************************************************************//**
*
* Sets the value of a programmable clock divider assigned to this Component.
* This is only used for integer dividers. Use Clock_B_SetFracDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_B_SetDivider(uint32_t dividerValue)
{
    (void)Cy_SysClk_PeriphSetDivider(Clock_B_DIV_TYPE, Clock_B_DIV_NUM, dividerValue);
}

/*******************************************************************************
* Function Name: Clock_B_GetDivider
****************************************************************************//**
*
...
* Use Clock_B_GetFracDivider() with a fractional divider.
*
* \param None
*
* \return
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t Clock_B_GetDivider(void)
{
    return Cy_SysClk_PeriphGetDivider(Clock_B_DIV_TYPE, Clock_B_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_B_SetFracDivider
****************************************************************************//**
*
* Sets the values of a programmable clock divider assigned to this Component.
* This is only used for fractional dividers. Use Clock_B_SetDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_B_SetFracDivider(uint32_t dividerIntValue, uint32_t dividerFracValue)
{
    (void)Cy_SysClk_PeriphSetFracDivider(Clock_B_DIV_TYPE, Clock_B_DIV_NUM, dividerIntValue, dividerFracValue);
}

/*******************************************************************************
* Function Name: Clock_B_GetFracDivider
****************************************************************************//**
*
...
* Use Clock_B_GetDivider() with an integer divider.
*
* \param *dividerIntValue
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_B_GetFracDivider(uint32_t *dividerIntValue, uint32_t *dividerFracValue)
{
    Cy_SysClk_PeriphGetFracDivider(Clock_B_DIV_TYPE, Clock_B_DIV_NUM, dividerIntValue, dividerFracValue);
}

/** @} general */

#endif /* CY_CLOCK_Clock_B_H */
