...
*
* \brief
* Provides the source code to the API for the Clock_G Component.
*
********************************************************************************
* \copyright
...
#if !defined(CY_Clock_G_NAME_Clock_G_H)
#define CY_Clock_G_NAME_Clock_G_H
...
#define Clock_G_DIV_NUM ((uint32_t)Clock_G__DIV_NUM)
/** The peripheral clock divider type */
#define Clock_G_DIV_TYPE ((cy_en_divider_types_t)Clock_G__DIV_TYPE)
/** @} group_macros */
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_G_Enable(void)
{
    (void)Cy_SysClk_PeriphEnableDivider(Clock_G_DIV_TYPE, Clock_G_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_G_Disable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_G_Disable(void)
{
    (void)Cy_SysClk_PeriphDisableDivider(Clock_G_DIV_TYPE, Clock_G_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_G_SetDivider
****************************************************************************//**
*
* Sets the value of a programmable clock divider assigned to this Component.
* This is only used for integer dividers. Use Clock_G_SetFracDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_G_SetDivider(uint32_t dividerValue)
{
    (void)Cy_SysClk_PeriphSetDivider(Clock_G_DIV_TYPE, Clock_G_DIV_NUM, dividerValue);
}

/*******************************************************************************
* Function Name: Clock_G_GetDivider
****************************************************************************//**
*
...
* Use Clock_G_GetFracDivider() with a fractional divider.
*
* \param None
*
* \return
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t Clock_G_GetDivider(void)
{
    return Cy_SysClk_PeriphGetDivider(Clock_G_DIV_TYPE, Clock_G_DIV_NUM);
}

/*******************************************************************************
* Function Name: Clock_G_SetFracDivider
****************************************************************************//**
*
* Sets the values of a programmable clock divider assigned to this Component.
* This is only used for fractional dividers. Use Clock_G_SetDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_G_SetFracDivider(uint32_t dividerIntValue, uint32_t dividerFracValue)
{
    (void)Cy_SysClk_PeriphSetFracDivider(Clock_G_DIV_TYPE, Clock_G_DIV_NUM, dividerIntValue, dividerFracValue);
}

/*******************************************************************************
* Function Name: Clock_G_GetFracDivider
****************************************************************************//**
*
...
* Use Clock_G_GetDivider() with an integer divider.
*
* \param *dividerIntValue
...
*
*******************************************************************************/
__STATIC_INLINE void Clock_G_GetFracDivider(uint32_t *dividerIntValue, uint32_t *dividerFracValue)
{
    Cy_SysClk_PeriphGetFracDivider(Clock_G_DIV_TYPE, Clock_G_DIV_NUM, dividerIntValue, dividerFracValue);
}
